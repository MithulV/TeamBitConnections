...
function Referral() {
    ...
    const handleSendInvitation = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/api/send-referral', {
                referrerEmail: email,
                    ...
                    <div className="flex-1 max-w-lg">
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-xl text-gray-600 mb-6">
                                Share our platform with people you know and help them discover something amazing.
                            </p>
                            
                            {/* Benefits List */}
                            <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
                                <h3 className="text-lg font-semibold text-green-800 mb-4">After successfully sending Invitation</h3>
                                   {/* Steps */}
                            <div className="mt-3">
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-8">
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                                <div className="flex items-start">
                                    ...
                                    <p className="ml-3 text-sm text-blue-800">
                                        <strong>How it works:</strong> They'll receive an email with a secure link to create their account and set their password.
                                    </p>
                                </div>
                            </div>
                            ...
                            <form onSubmit={handleSendInvitation} className="space-y-6">
                                ...
                                <button
                                    ...
                                    className={`w-full py-4 px-6 rounded-lg font-semibold text-white transition duration-200 transform ${
                            ...
                            <div className="text-center mt-8 pt-6 border-t border-gray-200">
                                <p className="text-xs text-gray-500">
                                    The invitation link expires in 24 hours and can only be used once.
                                </p>
                            </div>
                        </div>
                    </div>
