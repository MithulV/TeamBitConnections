...
function ContactNetworkAnalysis() {
  ...
  const prepareConnectionDistribution = () => {
    ...
    const users = networkData.networkData.nodes.filter(
      (n) => n.type === "user"
    );
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-6 border">
                  <div className="flex flex-wrap items-center gap-6 text-sm">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="font-medium text-gray-700">
                        Contacts ({networkData.totalContacts})
                      </span>
                    </div>
                    <div className="flex items-center">
            ...
            {activeTab === "statistics" && (
              <div>
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 mt-1">
                    Comprehensive overview of your network metrics and key
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
                  ...
                  <ul className="text-sm text-blue-800 space-y-1">
                    <li>
                      • <strong>Key Metrics Cards:</strong> Essential network
                      statistics at a glance
                    </li>
                    <li>
                      • <strong>Bar Charts:</strong> Visual comparison of
                      different network metrics
                    </li>
                    <li>
                      • <strong>Connection Distribution:</strong> How users are
                      distributed by connection count
                    </li>
                    <li>
                      • <strong>Network Health:</strong> Overall health and
                      density measurements
                    </li>
                    <li>
                      • <strong>AI Enhancement:</strong> Statistics powered by
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <div className="text-2xl font-bold text-gray-900">
                          {networkData.networkMetrics.averageConnectionsPerUser.toFixed(
                            1
                          )}
                        </div>
                        <div className="text-sm text-gray-600">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                  <div className="bg-white p-6 rounded-lg shadow border">
                    ...
                    <div className="h-80">
                      <Bar
                        data={prepareStatisticsBarChart()}
                  ...
                  <div className="bg-white p-6 rounded-lg shadow border">
                    ...
                    <div className="h-80">
                      <Doughnut
                        data={prepareConnectionDistribution()}
                        options={chartOptions}
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-white p-4 rounded-lg shadow">
                      ...
                      <div className="text-2xl font-bold text-blue-600 mb-1">
                        {(
                          networkData.networkMetrics.networkDensity * 100
                        ).toFixed(2)}
                        %
                      </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow">
                      ...
                      <p className="text-sm text-gray-600">
                        Direct connections in your network
                      </p>
                    </div>
            ...
            {activeTab === "analytics" && (
              <div>
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 mt-1">
                    Statistical analysis of your network structure and patterns
                  </p>
                </div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-8">
                  ...
                  <ul className="text-sm text-green-800 space-y-1">
                    <li>
                      • <strong>Radar Chart:</strong> Compares multiple network
                      metrics on a single view
                    </li>
                    <li>
                      • <strong>Doughnut Chart:</strong> Shows distribution of
                      users by connection count ranges
                    </li>
                    <li>
                      • <strong>Network Density:</strong> Measures how
                      interconnected your network is (0-100%)
                    </li>
                    <li>
                      • <strong>Total Relationships:</strong> Count of all
                      direct connections between nodes
                    </li>
                    <li>
                      • <strong>Referral Chains:</strong> Number of active
                      referral pathways in your network
                    </li>
                  </ul>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                  <div className="bg-white p-6 rounded-lg shadow border">
                    ...
                    <div className="h-80">
                      <Radar
                        data={prepareNetworkMetricsChart()}
            ...
            {activeTab === "insights" && (
              <div>
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 mt-1">
                    Neural network analysis of your network patterns and
                    predictions
                  </p>
                </div>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-8">
                  ...
                  <ul className="text-sm text-purple-800 space-y-1">
                    <li>
                      • <strong>Deep Learning:</strong> Multi-layer neural
                      networks analyze complex patterns
                    </li>
                    <li>
                      • <strong>LSTM Networks:</strong> Recurrent neural
                      networks for sequence prediction
                    </li>
                    <li>
                      • <strong>CNN Pattern Recognition:</strong> Convolutional
                      networks detect network features
                    </li>
                    <li>
                      • <strong>Autoencoders:</strong> Neural networks for
                      anomaly detection
                    </li>
                    <li>
                      • <strong>GANs:</strong> Generative networks for synthetic
                      data analysis
                    </li>
                    <li>
                      • <strong>Real Training:</strong> Networks learn from your
                      actual network data
                    </li>
                  </ul>
                </div>
            ...
            {activeTab === "influencers" && (
              <div>
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 mt-1">
                    Top users ranked by their network influence and connections
                  </p>
                </div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-8">
                  <h4 className="font-semibold text-yellow-900 mb-2">
                    How Influence Scoring Works:
                  </h4>
                  <ul className="text-sm text-yellow-800 space-y-1">
                    <li>
                      • <strong>Base Score:</strong> Direct connections count as
                      primary influence factor
                    </li>
                    <li>
                      • <strong>Hierarchy Bonus:</strong> Users higher in
                      network hierarchy get additional points
                    </li>
                    <li>
                      • <strong>Network Reach:</strong> Indirect connections
                      through referrals multiply influence
                    </li>
                    <li>
                      • <strong>Rankings:</strong> Gold (1st), Silver (2nd),
                      Bronze (3rd) medals for top performers
                    </li>
                    <li>
                      • <strong>Influence Meter:</strong> Visual bar showing
                      relative influence level (0-100%)
                    </li>
                  </ul>
                </div>
                      ...
                      <div className="mt-4">
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            ...
                            style={{
                              width: `${Math.min(
                                (influencer.influence_score / 50) * 100,
                                100
                              )}%`,
                            }}
                          ></div>
              ...
              <div>
                ...
                <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4 mb-8">
                  ...
                  <ul className="text-sm text-indigo-800 space-y-1">
                    <li>
                      • <strong>Search:</strong> Find nodes by name or email
                      address (real-time filtering)
                    </li>
                    <li>
                      • <strong>Filter:</strong> Show all nodes, only users, or
                      only contacts
                    </li>
                    <li>
                      • <strong>Node List:</strong> Browse through all network
                      members with key details
                    </li>
                    <li>
                      • <strong>Quick Stats:</strong> Summary of network
                      composition and structure
                    </li>
                    <li>
                      • <strong>Click to Select:</strong> Choose any node to
